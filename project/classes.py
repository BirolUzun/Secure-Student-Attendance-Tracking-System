...
def classescreate():
    ...
    students = User.query.filter_by(group="student").all()
    return render_template('createclass.html', teachers=teachers, students=students)
...
def classescreate_post():
    ...
    new_class = Classes(class_name=class_name, teacher_id=teacher_id, student_list=student_id)
